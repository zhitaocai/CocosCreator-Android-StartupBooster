...
@ccclass
export default class SloganSplashSceneCtrl extends cc.Component {
	@property(cc.Label)
	...
	private _hideNativeSplash() {
		if (CC_JSB) {
			if (cc.sys.os == cc.sys.OS_ANDROID) {
				jsb.reflection.callStaticMethod("org/cocos2dx/javascript/SloganSplashActivity", "hideSplash", "()V");
			}
		}
	}
